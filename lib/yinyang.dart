...
// # lib/features/home/presentation/widgets/yin_yang_button.dart
import 'dart:math' as math;

import 'package:flutter/material.dart';

class YinYangButton extends StatefulWidget {
  const YinYangButton({super.key});

  @override
  State<YinYangButton> createState() => _YinYangButtonState();
}

class _YinYangButtonState extends State<YinYangButton> with SingleTickerProviderStateMixin {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                ...
                colors: [
                  Color(0xFFF5F5DC), // Light cream for Yang
                  Color(0xFF2C3E50), // Dark blue for Yin
                ],
              ),
              boxShadow: [
                BoxShadow(
...
class _YinYangPainter extends CustomPainter {
  @override  void paint(Canvas canvas, Size size) {
    ...
    // Draw the black and white halves
